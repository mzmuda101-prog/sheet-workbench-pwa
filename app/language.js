...
const I18N = {
  pl: {
    ...
    cacheRefresh: "Czyszczę cache i odświeżam aplikację...",
    refreshingApp: "Odświeżam aplikację...",
    updateAvailable: "Jest dostępna nowsza wersja aplikacji.",
    ...
    trStoreImportBtn: "Przenieś",
    trStoreImportAria: "Przenieś zaznaczenia z pliku",
    trImportDone: "Przeniesiono {moved} z {all} zaznaczeń z „{name}” — {lost} nie znaleziono w tym pliku.",
    trImportNone: "Nic nie pasowało — treść wierszy różni się za bardzo, żeby bezpiecznie dopasować.",
    trNoticeSeeProgress: "Które to wiersze — zobaczysz w „Postęp”.",
    trScopeImported: "Przeniesione z innego pliku: {moved} z {all}, nieodnalezione {lost}.",
    trMatchHow: "Jak dopasowane:",
    trMatchExact: "{n} dokładnie",
    trMatchByKey: "{n} po kluczu",
    trMatchByKeyCol: "{n} po kolumnie „{col}”",
    trMatchSimilar: "{n} po podobieństwie",
    trUnmatchedTitle: "Nieodnalezione ✓ ({count})",
    trUnmatchedHint: "Tych wierszy nie ma w tym pliku albo ich treść zmieniła się za bardzo. Nic nie skasowałem — możesz je odhaczyć ręcznie.",
    trUnmatchedShowAll: "Pokaż listę",
    trUnmatchedHide: "Zwiń listę",
    trUnmatchedNear: "≈ {pct}%",
    trUnmatchedNoCandidate: "brak podobnego",
    trUnmatchedNoPreview: "(wiersz z zapisu bez podglądu)",
    trUnmatchedMore: "…i jeszcze {n}",
    trUnmatchedJumped: "Przeskoczyłem na najbardziej podobny wiersz — sprawdź i odhacz, jeśli się zgadza.",
    trUnmatchedGone: "Tego wiersza nie ma już na liście (może ukryty przez „Chowaj spisane”).",
    ...
    trTurboStarted: "Szybkie odhaczanie — puść, żeby zatrzymać",
    trTurboDone: "Szybko odhaczone: {n}",
    trTurboUndone: "Cofnięto {n} odhaczeń",
    trTurboEnd: "Koniec listy — zatrzymano na ostatnim wierszu",
    ...
    fileLoadFailedPassword: "Plik jest chroniony hasłem — usuń hasło w Excelu i spróbuj ponownie.",
    fileLoadFailedOldFormat: "Stary format .xls (binarny) może nie być w pełni wspierany — spróbuj zapisać plik jako .xlsx.",
    fileLoadFailedCorrupt: "Plik wygląda na uszkodzony lub to nie jest prawidłowy plik .xlsx/.xlsm.",
    fileLoadFailedEmpty: "Plik jest pusty (0 B).",
    fileLoadFailedDetail: "Nie udało się wczytać pliku: {detail}",
    cellsCopied: "Skopiowano {count} komórek",
    cellsPasted: "Wklejono {count} komórek",
    clipboardUnavailable: "Schowek niedostępny w tej przeglądarce/kontekście",
    cellsCopiedApp: "Skopiowano {count} komórek (schowek aplikacji — system odmówił)",
    cellsPastedApp: "Wklejono {count} komórek ze schowka aplikacji",
    cellsFilled: "Wypełniono {count} komórek",
    fillSkippedFormulas: "Pominięto {count} komórek — formuł nie wypełniamy",
    fillNeedsRange: "Zaznacz najpierw zakres (przytrzymaj Shift albo przeciągnij po komórkach)",
    cellActionsLabel: "Akcje",
    cellMenuAria: "Działania na komórce",
    cellMenuShowOnly: "Pokaż tylko takie",
    cellMenuHide: "Ukryj takie",
    cellMenuShowEmpty: "Pokaż tylko puste",
    cellMenuHideEmpty: "Ukryj puste",
    cellMenuCopy: "Kopiuj",
    cellMenuEmptyValue: "(pusta)",
    cellMenuUnsupported: "Tej wartości nie da się użyć w filtrze (zawiera && / || / { })",
    cellMenuNoHeader: "Ta kolumna nie ma nagłówka — nie da się po niej filtrować",
    cellMenuReplaced: "Poprzednie szukanie zastąpione — nie dało się go połączyć",
    activeFiltersAria: "Aktywne filtry",
    activeFiltersShown: "Widać {shown} z {total}",
    activeFiltersMarked: "Wyróżniono {count} z {total}",
    activeFiltersFilter2: "Filtr 2",
    activeFiltersDates: "Daty",
    activeFiltersLastDays: "ostatnie {n} dni",
    activeFiltersFrom: "od {d}",
    activeFiltersTo: "do {d}",
    activeFiltersOnlyData: "Tylko wiersze z danymi",
    activeFiltersSmart: "Tryby auto: {n}",
    activeFiltersValidation: "Tylko niezgodne z listą",
    activeFiltersNot: "NIE",
    activeFiltersCols: "{n} kol.",
    activeFiltersClearAll: "Wyczyść",
    activeFiltersClearAllAria: "Wyczyść wszystkie filtry",
    activeFiltersRemove: "Usuń filtr: {label}",
    cellActionsExpand: "Pokaż działania na zaznaczeniu",
    cellActionsCollapse: "Zwiń działania na zaznaczeniu",
    cellActionCopy: "Kopiuj",
    cellActionCopyAria: "Kopiuj zaznaczenie ({n} komórek)",
    cellActionPaste: "Wklej",
    cellActionFillDown: "Wypełnij w dół",
    cellActionFillDownShort: "w dół",
    cellActionFillRightShort: "w prawo",
    cellActionFillRight: "Wypełnij w prawo",
    pasteSkippedFormulas: "Pominięto {count} komórek — formuły ze schowka nie są wklejane",
    ...
    aggregationSearchPlaceholderOps: "np. Julian || Anna, >>100, kowal && !anna",
    ...
    // ── Tryby auto (smart filtry po stanie rekordu w powtarzalnych blokach) ──
    aggregationSmartNote: "Tryby auto są włączone — w źródle Wide-to-Long liczą się tylko trafione cykle.",
    smartChipOpen: "W toku",
    smartChipOpenHint: "Cykle zaczęte, ale bez daty końca — „od” jest, „do” puste.",
    smartChipClosed: "Zakończone",
    smartChipClosedHint: "Cykle z kompletną parą start–koniec.",
    smartChipOrphan: "Bez startu",
    smartChipOrphanHint: "Cykle, w których jest koniec, a brakuje daty początku — zwykle literówka albo luka w danych.",
    smartChipAllClosed: "Wszystko domknięte",
    smartChipAllClosedHint: "Wiersze, w których żaden cykl nie wisi otwarty.",
    smartChipNone: "Nic nie zaczęte",
    smartChipNoneHint: "Wiersze bez ani jednego wypełnionego cyklu.",
    smartChipLast: "Ostatni cykl",
    smartChipLastHint: "Zawęź do ostatniego wypełnionego cyklu w wierszu — np. „ostatni teren, jaki wziął”.",
    smartChipFirst: "Pierwszy cykl",
    smartChipFirstHint: "Zawęź do pierwszego wypełnionego cyklu w wierszu.",
    smartChipDays: "Dłużej niż N dni",
    smartChipDaysHint: "Cykle trwające co najmniej N dni (otwarte liczone do dziś).",
    smartChipUnavailable: "Ten tryb wymaga kolumn startu/końca w bloku — ustaw je w „Kolumny cyklu”.",
    smartClear: "Wyczyść tryby",
    smartShowCycles: "Pokaż same cykle",
    smartBackToRows: "Wróć do wierszy",
    smartShowCyclesHint: "Przełącza tabelę na listę cykli (Wide-to-Long) — widać wtedy wyłącznie trafione cykle, a nie całe szerokie wiersze.",
    smartColNone: "— brak —",
    smartStatusNoBlocks: "Ten arkusz nie ma powtarzalnych bloków kolumn, więc tryby auto są wyłączone.",
    smartStatusReady: "Wykryto {blocks} cykli × {span} kolumn",
    smartStatusRoles: "start: {start} · koniec: {end}",
    smartSourceHeaders: "role z nagłówków",
    smartSourceData: "role zgadnięte z danych",
    smartSourceManual: "role ustawione ręcznie",
    smartHintTokens: "To samo w polu szukania: @wtoku, @zakonczone, @bezstartu, @ostatni, @pierwszy, @dni30. Tekst i tryb auto łączą się w obrębie JEDNEGO cyklu.",
    smartHintNoStateCols: "Nie rozpoznałem kolumn startu i końca w bloku — wskaż je w „Kolumny cyklu”, żeby odblokować tryby stanu.",
  ...
  en: {
    ...
    trStoreImportBtn: "Import",
    trStoreImportAria: "Import checkmarks from file",
    trImportDone: "Moved {moved} of {all} checkmarks from “{name}” — {lost} not found in this file.",
    trImportNone: "Nothing matched — the row content is too different to map safely.",
    trNoticeSeeProgress: "Open “Progress” to see which rows those are.",
    trScopeImported: "Moved in from another file: {moved} of {all}, {lost} not found.",
    trMatchHow: "How it was matched:",
    trMatchExact: "{n} exactly",
    trMatchByKey: "{n} by key",
    trMatchByKeyCol: "{n} by column “{col}”",
    trMatchSimilar: "{n} by similarity",
    trUnmatchedTitle: "Not found ✓ ({count})",
    trUnmatchedHint: "These rows are not in this file, or their content changed too much. Nothing was deleted — you can tick them off by hand.",
    trUnmatchedShowAll: "Show list",
    trUnmatchedHide: "Hide list",
    trUnmatchedNear: "≈ {pct}%",
    trUnmatchedNoCandidate: "no close row",
    trUnmatchedNoPreview: "(row saved without a preview)",
    trUnmatchedMore: "…and {n} more",
    trUnmatchedJumped: "Jumped to the closest row — check it and tick it off if it matches.",
    trUnmatchedGone: "That row is no longer on the list (it may be hidden by “Hide done”).",
    ...
    trUndoBurst: "↶ Undo {n}",
    trTurboStarted: "Fast tick-off — release to stop",
    trTurboDone: "Fast-marked: {n}",
    trTurboUndone: "Undone {n} tick-offs",
    trTurboEnd: "End of list — stopped on the last row",
    ...
    fileLoadFailedPassword: "The file is password-protected — remove the password in Excel and try again.",
    fileLoadFailedOldFormat: "The old binary .xls format may not be fully supported — try saving the file as .xlsx.",
    fileLoadFailedCorrupt: "The file looks corrupted or isn't a valid .xlsx/.xlsm file.",
    fileLoadFailedEmpty: "The file is empty (0 B).",
    fileLoadFailedDetail: "Couldn't load the file: {detail}",
    cellsCopied: "Copied {count} cells",
    cellsPasted: "Pasted {count} cells",
    clipboardUnavailable: "Clipboard unavailable in this browser/context",
    cellsCopiedApp: "Copied {count} cells (app clipboard — the system refused)",
    cellsPastedApp: "Pasted {count} cells from the app clipboard",
    cellsFilled: "Filled {count} cells",
    fillSkippedFormulas: "Skipped {count} cells — formulas are not filled",
    fillNeedsRange: "Select a range first (hold Shift or drag across cells)",
    cellActionsLabel: "Actions",
    cellMenuAria: "Cell actions",
    cellMenuShowOnly: "Show only these",
    cellMenuHide: "Hide these",
    cellMenuShowEmpty: "Show only empty",
    cellMenuHideEmpty: "Hide empty",
    cellMenuCopy: "Copy",
    cellMenuEmptyValue: "(empty)",
    cellMenuUnsupported: "This value can't be used in a filter (contains && / || / { })",
    cellMenuNoHeader: "This column has no header — it can't be filtered by",
    cellMenuReplaced: "Previous search replaced — it couldn't be combined",
    activeFiltersAria: "Active filters",
    activeFiltersShown: "Showing {shown} of {total}",
    activeFiltersMarked: "Marked {count} of {total}",
    activeFiltersFilter2: "Filter 2",
    activeFiltersDates: "Dates",
    activeFiltersLastDays: "last {n} days",
    activeFiltersFrom: "from {d}",
    activeFiltersTo: "to {d}",
    activeFiltersOnlyData: "Only rows with data",
    activeFiltersSmart: "Auto modes: {n}",
    activeFiltersValidation: "Only list violations",
    activeFiltersNot: "NOT",
    activeFiltersCols: "{n} cols",
    activeFiltersClearAll: "Clear",
    activeFiltersClearAllAria: "Clear all filters",
    activeFiltersRemove: "Remove filter: {label}",
    cellActionsExpand: "Show selection actions",
    cellActionsCollapse: "Hide selection actions",
    cellActionCopy: "Copy",
    cellActionCopyAria: "Copy selection ({n} cells)",
    cellActionPaste: "Paste",
    cellActionFillDown: "Fill down",
    cellActionFillDownShort: "down",
    cellActionFillRightShort: "right",
    cellActionFillRight: "Fill right",
    pasteSkippedFormulas: "Skipped {count} cells — formulas from the clipboard aren't pasted",
    ...
    aggregationSearchPlaceholderOps: "e.g. Julian || Anna, >>100, smith && !anna",
    ...
    // ── Auto modes (smart filters by record state in repeating blocks) ──
    aggregationSmartNote: "Auto modes are on — in the Wide-to-Long source only matching cycles are counted.",
    smartChipOpen: "In progress",
    smartChipOpenHint: "Cycles that started but have no end date — „from” set, „to” empty.",
    smartChipClosed: "Finished",
    smartChipClosedHint: "Cycles with a complete start-end pair.",
    smartChipOrphan: "No start",
    smartChipOrphanHint: "Cycles with an end but no start date — usually a typo or a gap in the data.",
    smartChipAllClosed: "All closed",
    smartChipAllClosedHint: "Rows where no cycle is left open.",
    smartChipNone: "Nothing started",
    smartChipNoneHint: "Rows without a single filled cycle.",
    smartChipLast: "Last cycle",
    smartChipLastHint: "Narrow to the last filled cycle in the row — e.g. „the last area they took”.",
    smartChipFirst: "First cycle",
    smartChipFirstHint: "Narrow to the first filled cycle in the row.",
    smartChipDays: "Longer than N days",
    smartChipDaysHint: "Cycles running at least N days (open ones counted up to today).",
    smartChipUnavailable: "This mode needs start/end columns in the block — set them in „Cycle columns”.",
    smartClear: "Clear modes",
    smartShowCycles: "Show cycles only",
    smartBackToRows: "Back to rows",
    smartShowCyclesHint: "Switches the table to the cycle list (Wide-to-Long) — only matching cycles are shown instead of whole wide rows.",
    smartColNone: "— none —",
    smartStatusNoBlocks: "This sheet has no repeating column blocks, so auto modes are off.",
    smartStatusReady: "Detected {blocks} cycles × {span} columns",
    smartStatusRoles: "start: {start} · end: {end}",
    smartSourceHeaders: "roles from headers",
    smartSourceData: "roles guessed from data",
    smartSourceManual: "roles set manually",
    smartHintTokens: "Same thing in the search box: @open, @closed, @nostart, @last, @first, @days30. Text and auto mode combine within ONE cycle.",
    smartHintNoStateCols: "Could not spot start and end columns in the block — point them out in „Cycle columns” to unlock state modes.",
...
const STATIC_TRANSLATIONS = {
  pl: {
    ...
    smartColStartLabel: "Start cyklu",
    smartColEndLabel: "Koniec cyklu",
    smartColEntityLabel: "Osoba / obiekt",
    smartAutoDetectBtn: "Wykryj automatycznie",
    ...
    qsSpaceToggle: "przełącza pola wyboru w oknie szukania (np. „Operatory wyszukiwania”)",
    qsTabCycle: "krąży po kontrolkach okna szukania — lista wyników jest poza nim (wchodzisz w nią ↓)",
    qsEscBack: "zamyka okno szukania i oddaje fokus tam, skąd je otwarto",
    columns: "Kolumny",
    ...
    searchColExample: "np. 'Status:Anulowana', 'Status:!Anulowana', 'Kwota:>>1000', 'Klient:\"Jan Kowalski\"' · tekst w cudzysłowie = dosłownie · 'Status:=Anulowana' = cała komórka, 'Uwagi:=\"\"' = pusta, 'Uwagi:!=\"\"' = niepusta · prawy klik / przytrzymanie komórki = „Pokaż tylko takie”",
    ...
    searchLenStrong: "Długość tekstu komórki",
    searchLenRest: "— ten sam operator co wyżej, z prefiksem 'dl' (lub 'len')",
    searchLenExample: "np. 'dl>>20' (dłuższe niż 20 znaków), 'len<<=3'",
    searchRegexKbd: "Regex",
    searchRegexRest: "tryb „Regex” w polu „Tryb” filtra — dopasowanie wyrażeniem regularnym, niewrażliwe na wielkość liter",
    searchRegexExample: "np. '^FV-\\d+$' dopasuje „FV-102”, nie dopasuje „FV-102A”",
  ...
  en: {
    ...
    smartColStartLabel: "Cycle start",
    smartColEndLabel: "Cycle end",
    smartColEntityLabel: "Person / object",
    smartAutoDetectBtn: "Auto-detect",
    ...
    qsSpaceToggle: "toggles checkboxes in the search dialog (e.g. “Search operators”)",
    qsTabCycle: "cycles the search dialog controls — the results list stays out of it (enter it with ↓)",
    qsEscBack: "closes the search dialog and returns focus to where you opened it from",
    columns: "Columns",
    ...
    searchColExample: "e.g. 'Status:Cancelled', 'Status:!Cancelled', 'Amount:>>1000', 'Client:\"John Smith\"' · quoted text = literal · 'Status:=Cancelled' = whole cell, 'Notes:=\"\"' = empty, 'Notes:!=\"\"' = not empty · right-click / long-press a cell = “Show only these”",
    ...
    searchLenStrong: "Cell text length",
    searchLenRest: "— the same operator as above, with a 'dl' (or 'len') prefix",
    searchLenExample: "e.g. 'len>>20' (longer than 20 characters), 'len<<=3'",
    searchRegexKbd: "Regex",
    searchRegexRest: "“Regex” mode in the filter's “Mode” field — matches a regular expression, case-insensitive",
    searchRegexExample: "e.g. '^INV-\\d+$' matches “INV-102”, not “INV-102A”",
...
function applyStaticTranslations() {
  ...
  setText("#panel-smart-filters .panel-title", copy.smartPanelTitle);
  setText("#smartDaysLabel", copy.smartDaysLabel);
  setText("#smartFilterConfigTitle", copy.smartConfigTitle);
  setText("#smartStartColLabel", copy.smartColStartLabel);
  setText("#smartEndColLabel", copy.smartColEndLabel);
  setText("#smartEntityColLabel", copy.smartColEntityLabel);
  setButtonLabel("#smartResetColsBtn", copy.smartAutoDetectBtn);
  setAttr("#quickSearchSmartChips", "aria-label", copy.smartPanelTitle);
  // Chipy i status trybów auto mają teksty z t() — przerysuj po zmianie języka.
