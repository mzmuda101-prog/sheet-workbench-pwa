...
const I18N = {
  pl: {
    ...
    cellsCopied: "Skopiowano komórek: {count}",
    cellsPasted: "Wklejono komórek: {count}",
    clipboardUnavailable: "Schowek niedostępny w tej przeglądarce/kontekście",
    cellsCopiedApp: "Skopiowano komórek: {count} (schowek aplikacji — system odmówił)",
    cellsPastedApp: "Wklejono komórek: {count} (ze schowka aplikacji)",
    cellsFilled: "Wypełniono komórek: {count}",
    ...
    undoDone: "Cofnięto zmianę ({count} kom.)",
    redoDone: "Ponowiono zmianę ({count} kom.)",
    undoDoneSheet: "Cofnięto zmianę w arkuszu „{sheet}” ({count} kom.)",
    redoDoneSheet: "Ponowiono zmianę w arkuszu „{sheet}” ({count} kom.)",
    undoNothing: "Nie ma czego cofnąć",
    redoNothing: "Nie ma czego ponowić",
    qsHistoryPinned: "Przypięte",
    qsHistoryRecent: "Ostatnie",
    qsHistoryPin: "Przypnij zapytanie",
    qsHistoryUnpin: "Odepnij zapytanie",
    qsHistoryRemove: "Usuń z historii",
    qsHistoryClear: "Wyczyść ostatnie",
    ...
    cellMenuCopy: "Kopiuj",
    cellMenuPaste: "Wklej {value}",
    cellMenuPasteFill: "Wklej {value} do {count} komórek",
    cellMenuPasteBlock: "Wklej blok {rows}×{cols}",
    ...
    cellMenuMultiShow: "Pokaż wiersze z tymi wartościami",
    cellMenuMultiHide: "Ukryj wiersze z tymi wartościami",
    cellMenuMultiCopy: "Kopiuj zaznaczenie",
    cellMenuMultiHead: "{cells} kom. · {distinct} różn.",
    cellMenuMultiTooMany: "Za dużo różnych wartości w zaznaczeniu ({count}, max {max}) — zawęź zaznaczenie",
    cellMenuMultiAria: "Działania na zaznaczeniu",
    ...
    editToolApplied: "Zmieniono komórek: {count}",
  ...
  en: {
    ...
    undoDone: "Undid change ({count} cells)",
    redoDone: "Redid change ({count} cells)",
    undoDoneSheet: "Undid change in sheet “{sheet}” ({count} cells)",
    redoDoneSheet: "Redid change in sheet “{sheet}” ({count} cells)",
    undoNothing: "Nothing to undo",
    redoNothing: "Nothing to redo",
    qsHistoryPinned: "Pinned",
    qsHistoryRecent: "Recent",
    qsHistoryPin: "Pin query",
    qsHistoryUnpin: "Unpin query",
    qsHistoryRemove: "Remove from history",
    qsHistoryClear: "Clear recent",
    cellMenuShowOnly: "Show only these",
    cellMenuHide: "Hide these",
    cellMenuShowEmpty: "Show only empty",
    cellMenuHideEmpty: "Hide empty",
    cellMenuCopy: "Copy",
    cellMenuPaste: "Paste {value}",
    cellMenuPasteFill: "Paste {value} into {count} cells",
    cellMenuPasteBlock: "Paste {rows}×{cols} block",
    ...
    cellMenuMultiShow: "Show rows with these values",
    cellMenuMultiHide: "Hide rows with these values",
    cellMenuMultiCopy: "Copy selection",
    cellMenuMultiHead: "{cells} cells · {distinct} distinct",
    cellMenuMultiTooMany: "Too many distinct values in the selection ({count}, max {max}) — narrow it down",
    cellMenuMultiAria: "Selection actions",
...
const STATIC_TRANSLATIONS = {
  pl: {
    ...
    undoShortcut: "Cofnij zmianę w arkuszu (edycja, wklejenie, wypełnianie, narzędzia edycji)",
    redoShortcut: "Ponów (także Ctrl + Y)",
  ...
  en: {
    ...
    undoShortcut: "Undo a change in the sheet (edit, paste, fill, edit tools)",
    redoShortcut: "Redo (also Ctrl + Y)",
